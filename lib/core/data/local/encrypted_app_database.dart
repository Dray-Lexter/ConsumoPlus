...
abstract interface class AppDatabaseLifecycle {
  Future<void> delete();
}

class EncryptedAppDatabase implements AppDatabaseLifecycle {
  EncryptedAppDatabase(this._keyStore);

  // Kept stable to migrate current Water-only installations in place.
