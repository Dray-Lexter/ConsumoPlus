...
class SecureDatabaseKeyStore implements DatabaseKeyStore {
  ...
  factory SecureDatabaseKeyStore.production() {
    return SecureDatabaseKeyStore(storage: FlutterSecureValueStore());
  }
  ...
  Future<String> _loadOrCreate() async {
    final existing = await _storage.read(DatabaseKeyStore.waterKeyName);
    if (existing != null && existing.isNotEmpty) return existing;

    final generated = base64UrlEncode(_randomBytes(32));
    await _storage.write(DatabaseKeyStore.waterKeyName, generated);
    return generated;
  }
  ...
  Future<void> delete() async {
    ...
    await _storage.delete(DatabaseKeyStore.waterKeyName);
    _pendingKey = null;
  }
